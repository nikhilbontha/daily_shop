...
// Static files
app.use(express.static('public'));
// Serve admin uploaded images so storefront can access product images saved by admin UI
const path = require('path');
app.use('/admin/static/uploads', express.static(path.join(__dirname, 'admin', 'uploads')));
